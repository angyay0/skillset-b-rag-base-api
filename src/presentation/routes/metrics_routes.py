...
def create_metrics_blueprint() -> Blueprint:
    ...
    bp.route('/recent-activities', methods=['GET'])(with_metrics_controller('get_recent_activities'))
    
    # Demographics analytics endpoints
    bp.route('/demographics', methods=['GET'])(with_metrics_controller('get_demographics_report'))
    bp.route('/demographics/<field>', methods=['GET'])(with_metrics_controller('get_demographics_by_field'))
    bp.route('/demographics/cross-analysis', methods=['GET'])(with_metrics_controller('get_demographics_cross_analysis'))
