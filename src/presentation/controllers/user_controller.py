...
class UserController:
    ...
    def bulk_create_users(self):
        ...
        try:
            ...
            # Expect 'users' array in the payload
            ...
            results = self.user_service.bulk_create_users(users_data)
    ...
    def bulk_update_expiration(self):
        ...
        try:
            ...
            # Expect 'user_ids' array and 'validity_days' in the payload
            ...
            if validity_days is None:
                return jsonify({
                    'error': 'Missing required field',
                    'message': 'validity_days is required'
                }), 400

            if not isinstance(validity_days, int) or validity_days <= 0:
                return jsonify({
                    'error': 'Invalid value',
                    'message': 'validity_days must be a positive integer'
                }), 400

            # Process bulk update
            results = self.user_service.bulk_update_expiration(user_ids, validity_days)
            ...
            return jsonify({
                'message': 'Bulk expiration update completed',
                'summary': summary,
                'results': results
            }), 200
    ...
    def bulk_delete_users(self):
        ...
        try:
            ...
            # Expect 'user_ids' array in the payload
            user_ids = data.get('user_ids', [])
            ...
            results = self.user_service.bulk_delete_users(user_ids)
