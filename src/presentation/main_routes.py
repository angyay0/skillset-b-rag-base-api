...
def webhook_twilio():
    ...
    try:
        ...
        # Catch database session errors and return valid TwiML
        print(f"Critical error in webhook_twilio route: {str(e)}")
        import traceback
...
def register_routes(app):
    ...
    from src.presentation.routes.integration_routes import create_integration_blueprint
    ...
    integration_bp = create_integration_blueprint()
