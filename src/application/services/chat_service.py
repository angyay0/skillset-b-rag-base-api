...
class ChatService:
    ...
    def process_message(
        ...
        Args:
            phone_number: User identifier (can be actual phone or platform-specific ID like slack_U123)
            message_text: The message content
            channel: Channel name (whatsapp, slack, teams, etc.)
            language: Response language
            metadata: Additional metadata from the platform
            agent_id: Optional agent ID for agent-specific configurations
        """
